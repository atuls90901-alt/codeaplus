  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[10001] flex items-center justify-center p-4">
        <div className="w-full max-w-[500px] bg-[#0a0a0a] border border-gold/20 p-10 relative"
          ...
          {status === 'success' ? (
            <div className="text-center py-8">
              ...
              <button onClick={onClose}
                className="font-mono text-[10px] tracking-[.2em] uppercase text-[#060606] bg-gold px-8 py-3 mt-8 hover:bg-gold-light transition-colors">
                Close
              </button>
            </div>
          ) : (
            <>
                ...
                <div className="flex gap-2">
                  {[1, 2, 3, 4, 5].map(star => (
                    <button key={star} onClick={() => setForm({ ...form, rating: star })}
                      className={`text-3xl transition-all duration-150 ${star <= form.rating ? 'text-gold' : 'text-white/15'} hover:text-gold`}>
                      ★
                    </button>
                  ))}
                </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea className={`${iCls} resize-none min-h-[120px]`}
                    value={form.content}
                ...
                <div className="flex items-center gap-4 mt-2">
                  <button onClick={submit} disabled={status === 'loading'}
                    className="font-mono text-[11px] tracking-[.2em] uppercase text-[#060606] bg-gold px-8 py-3.5 relative overflow-hidden group disabled:opacity-60">
                  ...
                  <div className="font-mono text-[9px] tracking-[.1em] uppercase text-white/25 leading-relaxed">
