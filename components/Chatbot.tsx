...
export default function Chatbot() {
  ...
  return (
    <>
      ...
      <button
        onClick={() => setOpen(o => !o)}
        className="fixed bottom-8 right-8 z-[9000] w-14 h-14 flex items-center justify-center transition-all duration-300 hover:scale-110"
        style={{
      ...
      {/* Chat Window */}
      <div
        className="fixed bottom-28 right-8 z-[8999] w-[360px] flex flex-col"
        style={{
          height: 480,
          background: '#0a0a0a',
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              background: input.trim() ? 'linear-gradient(135deg,#7a6028,#C9A84C)' : 'rgba(255,255,255,0.05)',
              border:'1px solid rgba(201,168,76,0.2)',
              color: input.trim() ? '#060606' : 'rgba(201,168,76,0.3)',
