  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[10003] flex items-center justify-center p-4">
        <div className="w-full max-w-[500px] bg-[#0a0a0a] border border-gold/25 relative overflow-hidden"
          ...
          <button onClick={close}
            className="absolute top-4 right-4 font-mono text-[16px] text-white/30 hover:text-white transition-colors z-10">
            ✕
          </button>

          <div className="p-10 text-center">
            {/* Badge */}
            <div className="inline-block font-mono text-[9px] tracking-[.3em] uppercase text-[#060606] bg-gold px-4 py-1.5 mb-6">
              Limited Offer
            </div>

            <h2 className="font-cormorant text-[38px] font-light leading-[1.1] mb-4">
              Wait! Get a <em className="italic text-gold">Free</em><br />Project Consultation
            </h2>

            <p className="text-[14px] text-white/50 font-light leading-[1.7] mb-8 max-w-[360px] mx-auto">
            ...
            <div className="flex flex-col gap-3 items-center">
              <a href="#contact" onClick={close}
                className="font-mono text-[11px] tracking-[.2em] uppercase text-[#060606] bg-gold px-10 py-4 w-full text-center relative overflow-hidden group">
            ...
            {/* Trust signals */}
            <div className="flex justify-center gap-8 mt-8 pt-6 border-t border-gold/10">
